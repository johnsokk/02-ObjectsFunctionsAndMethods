...
def main():
    ...
    # -------------------------------------------------------------------------
    even_better_draw_circles(rg.Point(100, 50,), 40, 8, 'Pink', 10)
    even_better_draw_circles(rg.Point(-200, 0), 5, 20, 'Blue', 16)
    even_better_draw_circles(rg.Point(150, 60), 30, 15, 'Green', 10)
    even_better_draw_circles(rg.Point(125, 28), 22, 4, 'Violet', 12)
    even_better_draw_circles(rg.Point(-100, -50), 5, 6, 'Gold', 1)
...
def better_draw_circles(point, distance):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN distance pixels, ending up pointing east again
        turtle.right(90)
...
def even_better_draw_circles(point, distance, b, color, thickness):
    ...
    for k in range(1, b+1):  # k becomes 1, 2, 3, ... 10
